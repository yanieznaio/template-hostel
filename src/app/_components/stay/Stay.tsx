...
const Stay = () => {
    ...
    return (
        <>
            ...
            <div className='mt-40 flex flex-col md:flex-row md:px-20 px-4 md:gap-20 max-w-7xl m-auto'>
                <div className='border border-black p-2 md:w-1/2 w-full '>
                    <div className='relative h-[300px] md:h-[90vh] w-full '>
                ...
                <div className='w-full md:w-1/2 flex flex-col gap-10 pt-20'>
                    <h1>Lorem ipsum</h1>
                    <p>lorem ipsum sit amet</p>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fuga, dolores hic suscipit autem animi praesentium. At error libero id excepturi ipsum rem, quae animi delectus, aliquid tempora labore ut? A?.</p>
                    <Link href="/" className=' border-b border-black w-fit'>Vor détail</Link>
                </div>
